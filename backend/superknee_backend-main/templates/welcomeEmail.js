    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border-top: 8px solid #006d63; background-color: #ffffff; padding: 0;">
      <div style="padding: 30px 20px;">
        <h1 style="color: #004d40; font-size: 36px; margin-bottom: 5px; font-weight: 800; letter-spacing: -1px;">
          WELCOME <span style="color: #006d63;">Super Health</span>
        </h1>
        ...
        <p style="color: #444; line-height: 1.6; font-size: 15px; margin-bottom: 20px;">
          We are delighted to welcome you to the Super Health family! Your account has been successfully created and you are now part of a community dedicated to better health and recovery.
        </p>
        ...
        <div style="margin: 40px 0; padding: 30px; border: 1px dashed #006d63; text-align: center; border-radius: 4px; background-color: #f9fdfc;">
          <p style="color: #006d63; font-weight: bold; font-size: 16px; margin-bottom: 20px;">Unlock your potential today.</p>
          <a href="https://superknee.com/shop" style="background-color: #006d63; color: #ffffff; padding: 14px 35px; text-decoration: none; border-radius: 4px; font-weight: bold; display: inline-block; text-transform: uppercase; font-size: 14px;">
            VISIT OUR SHOP
          </a>
        </div>
